...
export default function AssignmentEditor() {
    const { cid = "", aid = "New" } = useParams<{ cid?: string; aid?: string }>();
        ...
        <div className="p-3">
            ...
            <Form>
                ...
                <Form.Group as={Row} className="mb-3">
                    ...
                    <Col sm={6}>
                        <Form.Select disabled><option>ASSIGNMENTS</option></Form.Select>
                    </Col>
                </Form.Group>
                ...
                <Form.Group as={Row} className="mb-3">
                    ...
                    <Col sm={6}>
                        <Form.Select disabled><option>Percentage</option></Form.Select>
                    </Col>
                </Form.Group>

                <Form.Group className="mb-4">
                    <Form.Label>Submission Type</Form.Label>
                    <Form.Select disabled><option>Online</option></Form.Select>
                    <div className="border rounded p-3 mt-2">
                        <strong>Online Entry Options</strong>
                        <Form.Check type="checkbox" label="Text Entry" checked disabled className="mt-2" />
